    ...
    <form action="proses_dsn.php?aksi=update" method="post">
        ...
        ?>
            <table>
                ...
                <tr>
                    <td>Nama</td>
                    <td><input class="form-control" type=" text" name="nama" value="<?php echo $d['nama'] ?>">
                    </td>
                </tr>
                <tr>
                    <td>Agama</td>
                    <td><input class="form-control" type=" text" name="agama" value="<?php echo $d['agama'] ?>">
                    </td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td><textarea class="form-control" name=" alamat" cols="30" rows="5"><?php echo $d['alamat'] ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td></td>
